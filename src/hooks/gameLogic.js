...
const GameLogic = (boardSize) => {
    ...
    useEffect(() => {
        ...
        if((mode === "AI" && ((state.initialPlayer === "player2" && state.playAs==="player1") || (state.initialPlayer === "player1" && state.playAs==="player2"))) || (mode==="CwsC" && ((state.playAs === "player1" && state.initialPlayer==="player1") || (state.playAs === "player2" && state.initialPlayer==="player2")))){
            
            updatePossibleActions();
            
        }if((mode === "Bot" && ((state.initialPlayer === "player2" && state.playAs==="player1") || (state.initialPlayer === "player1" && state.playAs==="player2"))) || (mode==="CwsC" && ((state.playAs === "player2" && state.initialPlayer==="player1") || (state.playAs === "player1" && state.initialPlayer==="player2")))){
    ...
    const movePlayer = (rowIndex, colIndex) => {
        ...
        if (initialPlayer === 'player1' && rowIndex === 0) {
            alert(`${nickNames[0]} wins!`);
        }
        if (initialPlayer === 'player2' && rowIndex === 8) {
            alert(`${nickNames[1]} wins!`);
        }
    };
